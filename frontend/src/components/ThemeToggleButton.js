...
import './ThemeToggleButton.css'; // Will create this CSS file later
    ...
    <label className="theme-toggle-button-label">
      ...
      <svg viewBox="0 0 69.667 44" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
          <rect className="container" transform="translate(3.5 3.5)" rx="17.5" height={35} width="60.667" />
          <g transform="translate(2.333 2.333)" className="button-group">
            <g className="sun">
              <circle className="sun-outer" r="15.167" cy="15.167" cx="15.167" />
              <path className="sun-inner-shadow" d="M11.667,0A11.667,11.667,0,1,1,0,11.667,11.667,11.667,0,0,1,11.667,0Z" />
              <circle className="sun-inner" r={7} cy={7} cx={7} />
            </g>
            <g className="moon">
              <circle className="moon-outer" r="15.167" cy="15.167" cx="15.167" />
              <g className="moon-patches">
          ...
          <g className="cloud">
            <path d="M3512.81,173.815a4.463,4.463,0,0,1,2.243.62.95.95,0,0,1,.72-1.281,4.852,4.852,0,0,1,2.623.519c.034.02-.5-1.968.281-2.716a2.117,2.117,0,0,1,2.829-.274,1.821,1.821,0,0,1,.854,1.858c.063.037,2.594-.049,3.285,1.273s-.865,2.544-.807,2.626a12.192,12.192,0,0,1,2.278.892c.553.448,1.106,1.992-1.62,2.927a7.742,7.742,0,0,1-3.762-.3c-1.28-.49-1.181-2.65-1.137-2.624s-1.417,2.2-2.623,2.2a4.172,4.172,0,0,1-2.394-1.206,3.825,3.825,0,0,1-2.771.774c-3.429-.46-2.333-3.267-2.2-3.55A3.721,3.721,0,0,1,3512.81,173.815Z" transform="translate(-3466.47 -160.94)" />
          </g>
          <g className="stars">
